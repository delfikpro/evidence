...
public class ItemRender {
	...
	public static void draw(ScaledImage i, String name, int slot, int x) throws IOException {
		draw(i, name, slot, x, 1);
	}
	public static void draw(ScaledImage i, String name, int slot, int x, int size) throws IOException {
		BufferedImage img = ResourcePack.getTexture("assets/minecraft/textures/items/" + name + ".png");
